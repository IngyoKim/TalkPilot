...
// in talk_pilot/test/services/database/user_service_test.dart.
...
import 'package:talk_pilot/src/services/database/database_service.dart' as _i5;
...
class MockDatabaseService extends _i1.Mock implements _i5.DatabaseService {
  ...
  @override
  _i6.Future<void> writeDB(String? path, Map<String, dynamic>? data) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<T?> readDB<T>(String? path) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> updateDB(String? path, Map<String, dynamic>? updates) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> deleteDB(String? path) =>
      (super.noSuchMethod(
