...
// in talk_pilot/test/services/database/cpm_history_service_test.dart.
...
import 'package:talk_pilot/src/models/user_model.dart' as _i6;
import 'package:talk_pilot/src/services/database/database_service.dart' as _i3;
import 'package:talk_pilot/src/services/database/user_service.dart' as _i5;
...
class MockUserService extends _i1.Mock implements _i5.UserService {
  ...
  @override
  _i4.Future<_i6.UserModel?> readUser(String? uid) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> initUser(_i7.User? firebaseUser, {String? loginMethod}) =>
      (super.noSuchMethod(
            Invocation.method(
              #initUser,
              [firebaseUser],
